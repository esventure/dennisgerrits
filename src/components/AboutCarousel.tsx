    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[70vh]">
      ...
      <div className="relative overflow-hidden px-6 sm:px-10 md:px-16 lg:px-20 py-14 sm:py-20 lg:py-28 flex items-center min-h-[70vh]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, hsl(var(--background)) 0%, hsl(var(--background) / 0.98) 30%, hsl(var(--background) / 0.75) 55%, hsl(var(--background) / 0) 100%)",
          }}
          aria-hidden
        />
      ...
      <div className="relative overflow-hidden px-6 sm:px-10 md:px-16 lg:px-20 py-14 sm:py-20 lg:py-28 flex items-center min-h-[70vh]">
        <div
          className="absolute inset-0 bg-cover bg-[100%_center]"
