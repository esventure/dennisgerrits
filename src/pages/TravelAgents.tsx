          ...
          <div className="max-w-3xl mb-16">
            <FadeIn>
              ...
              <p className="font-body text-lg text-muted-foreground leading-relaxed">
                ...
                authentic, personalised experiences for their clients. If that sounds like you,
              ...
              {[
                {
                  ...
                  text: "A reliable, premium experience that reflects well on your brand. I handle every detail, from personalised itinerary research to day-of execution, so your clients feel genuinely cared for.",
                },
                {
                  title: "How It Works",
