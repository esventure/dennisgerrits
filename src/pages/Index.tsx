          ...
          <div className="max-w-5xl mx-auto">
            {(() => {
              const rows = [
                ...
                { icon: iconBoat, title: t("concierge.private.title", "Private Cars & Boats"), desc: t("concierge.private.desc", "Arranging private cars and boats for comfortable and seamless travel."), filter: "contrast(3.5) brightness(0.4) saturate(2.5)" },
