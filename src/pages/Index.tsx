          ...
          <div className="max-w-5xl mx-auto">
            {(() => {
              const rows = [
                ...
                { icon: iconDining, title: t("concierge.dining.title", "Dining Reservations"), desc: t("concierge.dining.desc", "Thoughtfully selected restaurants, from local favorites to memorable dining experiences."), filter: "sepia(0.5) saturate(2.2) hue-rotate(-12deg) contrast(1.1)" },
                ...
                { icon: iconBoat, title: t("concierge.private.title", "Private Cars & Boats"), desc: t("concierge.private.desc", "Arranging private cars and boats for comfortable and seamless travel."), filter: "contrast(1.5) brightness(0.85) saturate(1.6)" },
